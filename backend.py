...
class Llava:
  ...
  def gradio(self):
    gr.close_all()
    icon_url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR35P4bAY1rz8h7H0plGmHq1iWZefk_Eo7YTw&s"  
    demo = gr.Interface(fn=self.captioner,
                        ...
                        title=f'<img src="{icon_url}" style="width:30px;height:30px;vertical-align:middle;">Visai by Communication Crafts',
                        description="Caption any image using the Visai!",
